...
const slides = computed(() => sliceSlides(props.cards));
...
<template>
  <carousel
      ...
      indicator:
        'size-2 rounded-full bg-white/15 ring-2 ring-white/5 data-[active=true]:bg-transparent data-[active=true]:ring-primary transition',
      dots: 'gap-4',
...
.fx-card__inner {
  ...
  overflow: hidden;
  background:
      radial-gradient(900px 300px at 18% 10%, rgba(128, 90, 245, 0.10), transparent 60%),
...
@keyframes fx-sheenDiag {
  ...
  to   { transform: translateX(240%) rotate(25deg); }
}
