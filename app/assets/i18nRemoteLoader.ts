...
function getI18n(nuxtApp: any): I18nLike {
    const i18n = nuxtApp.$i18n as any;
    if (!i18n) throw new Error('nuxtApp.$i18n is not available. Is @nuxtjs/i18n installed?');
    return i18n;
}

function setMessages(i18n: I18nLike, lang: string, messages: any) {
...
function hasMessages(i18n: I18nLike, lang: string): boolean {
    const msg =
